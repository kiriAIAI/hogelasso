from flask import Flask, render_template, request, session,redirect, url_for,send_from_directory, jsonify, redirect
...
def register():
    if request.method == 'POST':
        ...
        return render_template('security_questions.html', username=username, email=email, password=password)
